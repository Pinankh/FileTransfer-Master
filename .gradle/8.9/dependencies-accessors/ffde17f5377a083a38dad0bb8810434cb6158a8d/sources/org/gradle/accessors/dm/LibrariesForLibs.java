...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>barcodescan</b> with <b>com.google.mlkit:barcode-scanning</b> coordinates and
     * with version reference <b>barcodescan</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getBarcodescan() {
        return create("barcodescan");
    }
    ...
    /**
     * Dependency provider for <b>netty</b> with <b>io.netty:netty-all</b> coordinates and
    ...
    /**
     * Dependency provider for <b>qrcodegen</b> with <b>com.github.kenglxn.QRGen:android</b> coordinates and
     * with version reference <b>qrcodegen</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getQrcodegen() {
        return create("qrcodegen");
    }

    /**
     * Dependency provider for <b>rxandroid3</b> with <b>io.reactivex.rxjava3:rxandroid</b> coordinates and
     * with version reference <b>rxandroid3</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getRxandroid3() {
        return create("rxandroid3");
    }

    /**
     * Dependency provider for <b>rxjava3</b> with <b>io.reactivex.rxjava3:rxjava</b> coordinates and
     * with version reference <b>rxjava3</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    /**
     * Dependency provider for <b>rxkotlin3</b> with <b>io.reactivex.rxjava3:rxkotlin</b> coordinates and
     * with version reference <b>rxkotlin3</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getRxkotlin3() {
        return create("rxkotlin3");
    }
    ...
    /**
     * Dependency provider for <b>tuiutils</b> with <b>io.github.tans5:tuiutils</b> coordinates and
     * with version reference <b>tuiutils</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getTuiutils() {
        return create("tuiutils");
    }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>annotaion</b> with <b>androidx.annotation:annotation</b> coordinates and
         * with version reference <b>annotaion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAnnotaion() {
            return create("androidx.annotaion");
        }
    ...
    public static class AndroidxLifecycleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>rumtime</b> with <b>androidx.lifecycle:lifecycle-runtime-ktx</b> coordinates and
         * with version reference <b>lifecycle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRumtime() {
            return create("androidx.lifecycle.rumtime");
        }
    ...
    public static class CoroutinesLibraryAccessors extends SubDependencyFactory {
        private final CoroutinesCoreLibraryAccessors laccForCoroutinesCoreLibraryAccessors = new CoroutinesCoreLibraryAccessors(owner);

        public CoroutinesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-android</b> coordinates and
         * with version reference <b>corouines</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Dependency provider for <b>rx3</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-rx3</b> coordinates and
         * with version reference <b>corouines</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRx3() {
            return create("coroutines.rx3");
        }

        /**
         * Group of libraries at <b>coroutines.core</b>
         */
        public CoroutinesCoreLibraryAccessors getCore() {
            return laccForCoroutinesCoreLibraryAccessors;
        }

    }

    public static class CoroutinesCoreLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public CoroutinesCoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getJvm() {
            return create("coroutines.core.jvm");
        }
    ...
    public static class RxbindingLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>appcompat</b> with <b>com.jakewharton.rxbinding4:rxbinding-appcompat</b> coordinates and
         * with version reference <b>rxbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAppcompat() {
            return create("rxbinding.appcompat");
        }

        /**
         * Dependency provider for <b>core</b> with <b>com.jakewharton.rxbinding4:rxbinding-core</b> coordinates and
         * with version reference <b>rxbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("rxbinding.core");
        }

        /**
         * Dependency provider for <b>swiperefreshlayout</b> with <b>com.jakewharton.rxbinding4:rxbinding-swiperefreshlayout</b> coordinates and
         * with version reference <b>rxbinding</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSwiperefreshlayout() {
            return create("rxbinding.swiperefreshlayout");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>annotaion</b> with value <b>1.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAnnotaion() { return getVersion("annotaion"); }
        ...
        /**
         * Version alias <b>barcodescan</b> with value <b>17.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBarcodescan() { return getVersion("barcodescan"); }
        ...
        /**
         * Version alias <b>corouines</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCorouines() { return getVersion("corouines"); }
        ...
        /**
         * Version alias <b>googleKsp</b> with value <b>2.0.21-1.0.26</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>netty</b> with value <b>4.1.86.Final</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>qrcodegen</b> with value <b>3.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getQrcodegen() { return getVersion("qrcodegen"); }
        ...
        /**
         * Version alias <b>rxandroid3</b> with value <b>3.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRxandroid3() { return getVersion("rxandroid3"); }

        /**
         * Version alias <b>rxbinding</b> with value <b>4.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxjava3</b> with value <b>3.1.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRxjava3() { return getVersion("rxjava3"); }

        /**
         * Version alias <b>rxkotlin3</b> with value <b>3.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRxkotlin3() { return getVersion("rxkotlin3"); }
        ...
        /**
         * Version alias <b>threetenabp</b> with value <b>1.4.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tuiutils</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTuiutils() { return getVersion("tuiutils"); }
