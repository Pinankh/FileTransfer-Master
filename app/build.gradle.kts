...
android {
    ...
    namespace = "com.wifitransferfile.android"
    compileSdk = properties["ANDROID_COMPILE_SDK"].toString().toInt()

    defaultConfig {
        applicationId = "com.wifitransferfile.android"
        ...
        setProperty("archivesBaseName", "filetransfer-${properties["VERSION_NAME"].toString()}")
    }
